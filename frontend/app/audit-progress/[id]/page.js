  ...
  const rawSteps = [
    {
      id: 1,
      title: "Orchestrator",
      description: "Task parameters initialized and delegated.",
      icon: (
    ...
    },
    {
      id: 2,
      title: "Crawl Agent",
      description: "Deep domain traversal complete.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      id: 3,
      title: "SEO Analyst",
      description: "Evaluating core web vitals and keyword density...",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      ...
      description: "Awaiting structural analysis...",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      ...
      description: "Pending insight aggregation...",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      ...
      description: "Final quality and compliance check pending.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
