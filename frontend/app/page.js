...
export default async function Home({ searchParams }) {
  ...
  return (
    <div className="">
      {sessionExpired && (
        <div className="absolute top-24 left-1/2 -translate-x-1/2 bg-red-500/10 border border-red-500 text-red-500 px-6 py-3 rounded-2xl font-medium z-50 shadow-lg flex items-center gap-3 transition-all">
